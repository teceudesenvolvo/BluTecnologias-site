...
export type ServiceInventoryProduct={id:string;name:string;unit:string;stockQuantity:number;active:boolean};
export type ServiceFoundation={services:ServiceDefinition[];inventoryProducts:ServiceInventoryProduct[];categories:ServiceCategory[];professionals:ServiceProfessional[];clients:ServiceEntity[];appointments:ServiceEntity[];resources:ServiceEntity[];packages:ServiceEntity[];commissions:ServiceEntity[];settings:ServiceSettings|null};
...
export const serviceSchedulingService={
  ...
  completeAppointment:(companyId:string,id:string)=>call<{id:string;deducted:boolean}>(companyId,'complete_appointment',undefined,id),
