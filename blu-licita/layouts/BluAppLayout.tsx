...
const quickFeatures = [
  ...
  { label: 'Novo recibo', to: '/admin/recibos', description: 'Emitir recibo para produtos, serviços e clientes avulsos', keywords: 'recibo comprovante cliente produto serviço pagamento pdf' },
