...
export const ReceiptsPage = () => {
  ...
  const client = selectedClient ? { ...selectedClient, name: selectedClient.name || selectedClient.razaoSocial || selectedClient.tradeName || "Cliente" , document: selectedClient.document || selectedClient.cnpj || selectedClient.cpf || "" } : manualClient;
